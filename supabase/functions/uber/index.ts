...
serve(async (req) => {
  ...
  // 🔒 Security check: Require valid user JWT authentication header
  ...
  try {
    ...
    if (!pickupAddress || !dropoffAddress || !itemDescription || itemValue == null) {
    ...
    console.error("Uber function error:", err)
